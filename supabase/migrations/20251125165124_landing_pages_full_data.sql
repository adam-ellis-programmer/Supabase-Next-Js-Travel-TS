...
INSERT INTO landing_pages (
  ...
  'https://images.unsplash.com/photo-1548013146-72479768bada?w=1200',
  'Asia is the world''s largest and most diverse continent, home to ancient civilizations, modern megacities, tropical paradises, and spiritual sanctuaries. From the Great Wall of China to tropical Thai beaches, from Japanese cherry blossoms to Indian palaces, Asia offers endless discoveries for every traveler.',
  'October to April (varies by region)',
  'Multiple currencies across countries',
  'Multiple languages',
  'Asia/Tokyo',
  'Visa requirements vary by country',
  ARRAY['Taj Mahal', 'Angkor Wat', 'Great Wall of China', 'Mount Fuji', 'Ha Long Bay', 'Petronas Towers', 'Borobudur', 'Forbidden City']
);

INSERT INTO landing_page_destinations (landing_page_id, name, image_url, description, display_order)
VALUES 
  ((SELECT id FROM landing_pages WHERE slug = 'asia'), 'Japan', 'https://images.unsplash.com/photo-1493976040374-85c8e12f0c0e?w=400', 'Ancient traditions meet futuristic innovation', 1),
  ((SELECT id FROM landing_pages WHERE slug = 'asia'), 'Thailand', 'https://images.unsplash.com/photo-1552465011-b4e21bf6e79a?w=400', 'Tropical beaches and golden temples', 2),
  ((SELECT id FROM landing_pages WHERE slug = 'asia'), 'India', 'https://images.unsplash.com/photo-1548013146-72479768bada?w=400', 'Colorful culture and spiritual heritage', 3),
  ((SELECT id FROM landing_pages WHERE slug = 'asia'), 'Vietnam', 'https://images.unsplash.com/photo-1528127269322-539801943592?w=400', 'Stunning landscapes and rich history', 4);

INSERT INTO landing_page_experiences (landing_page_id, icon, title, description, display_order)
VALUES 
  ((SELECT id FROM landing_pages WHERE slug = 'asia'), 'FaGlobe', 'Ancient Cultures', 'Temples, palaces, and traditions', 1),
  ((SELECT id FROM landing_pages WHERE slug = 'asia'), 'FaUtensils', 'Asian Cuisine', 'Diverse flavors and street food', 2),
  ((SELECT id FROM landing_pages WHERE slug = 'asia'), 'FaUmbrellaBeach', 'Tropical Islands', 'Beach paradises across the continent', 3),
  ((SELECT id FROM landing_pages WHERE slug = 'asia'), 'FaMountain', 'Natural Wonders', 'Mountains, jungles, and landscapes', 4);

INSERT INTO landing_page_travel_tips (landing_page_id, icon, title, tip, display_order)
VALUES 
  ((SELECT id FROM landing_pages WHERE slug = 'asia'), 'FaClock', 'Best Time', 'October-April for most of Asia; avoid monsoon seasons', 1),
  ((SELECT id FROM landing_pages WHERE slug = 'asia'), 'FaPlane', 'Getting Around', 'Budget airlines connect major cities; trains in developed countries', 2),
  ((SELECT id FROM landing_pages WHERE slug = 'asia'), 'FaMoneyBillWave', 'Budget', 'Very affordable; $30-80 per day in most countries', 3),
  ((SELECT id FROM landing_pages WHERE slug = 'asia'), 'FaGlobe', 'Cultural Respect', 'Dress modestly at temples; remove shoes when entering homes', 4);
...
INSERT INTO landing_pages (
  ...
  'South America',
  'south-america',
  'Land of Passion and Natural Splendor',
  'https://images.unsplash.com/photo-1526392060635-9d6019884377?w=1200',
  'South America captivates with its dramatic landscapes, from the Amazon rainforest to Patagonian glaciers, from ancient Incan ruins to vibrant modern cities. Experience passionate tango, carnival celebrations, incredible biodiversity, colonial architecture, and warm Latin hospitality.',
  'September to November (Spring), March to May (Fall)',
  'Multiple currencies across countries',
  'Spanish, Portuguese',
  'America/Sao_Paulo',
  'Visa requirements vary by country',
  ARRAY['Machu Picchu', 'Christ the Redeemer', 'Iguazu Falls', 'Galapagos Islands', 'Patagonia', 'Amazon Rainforest', 'Atacama Desert', 'Cartagena Old Town']
);

INSERT INTO landing_page_destinations (landing_page_id, name, image_url, description, display_order)
VALUES 
  ((SELECT id FROM landing_pages WHERE slug = 'south-america'), 'Peru', 'https://images.unsplash.com/photo-1526392060635-9d6019884377?w=400', 'Machu Picchu and Incan heritage', 1),
  ((SELECT id FROM landing_pages WHERE slug = 'south-america'), 'Brazil', 'https://images.unsplash.com/photo-1483729558449-99ef09a8c325?w=400', 'Carnival spirit and tropical paradise', 2),
  ((SELECT id FROM landing_pages WHERE slug = 'south-america'), 'Argentina', 'https://images.unsplash.com/photo-1589909202802-8f4aadce1849?w=400', 'Tango, wine, and Patagonian beauty', 3),
  ((SELECT id FROM landing_pages WHERE slug = 'south-america'), 'Colombia', 'https://images.unsplash.com/photo-1568632234157-ce7aecd03d0d?w=400', 'Colonial cities and coffee culture', 4);

INSERT INTO landing_page_experiences (landing_page_id, icon, title, description, display_order)
VALUES 
  ((SELECT id FROM landing_pages WHERE slug = 'south-america'), 'FaMountain', 'Adventure', 'Andes mountains and jungle treks', 1),
  ((SELECT id FROM landing_pages WHERE slug = 'south-america'), 'FaCamera', 'Ancient Ruins', 'Incan and pre-Columbian sites', 2),
  ((SELECT id FROM landing_pages WHERE slug = 'south-america'), 'FaUtensils', 'Latin Cuisine', 'Ceviche, asado, and tropical fruits', 3),
  ((SELECT id FROM landing_pages WHERE slug = 'south-america'), 'FaGlobe', 'Wildlife', 'Amazon biodiversity and unique species', 4);

INSERT INTO landing_page_travel_tips (landing_page_id, icon, title, tip, display_order)
VALUES 
  ((SELECT id FROM landing_pages WHERE slug = 'south-america'), 'FaClock', 'Best Time', 'Varies by region; avoid rainy seasons in Amazon and Andes', 1),
  ((SELECT id FROM landing_pages WHERE slug = 'south-america'), 'FaPlane', 'Getting Around', 'Long-distance buses are common; flights between major cities', 2),
  ((SELECT id FROM landing_pages WHERE slug = 'south-america'), 'FaMoneyBillWave', 'Budget', '$40-80 per day for mid-range travel', 3),
  ((SELECT id FROM landing_pages WHERE slug = 'south-america'), 'FaGlobe', 'Safety', 'Stay aware in cities; use registered taxis or ride apps', 4);
...
INSERT INTO landing_pages (
  ...
  'https://images.unsplash.com/photo-1489749798305-4fea3ae63d43?w=1200',
  'Africa is a continent of extraordinary diversity and raw beauty. Experience thrilling safaris, ancient pyramids, vibrant cultures, Sahara Desert adventures, pristine beaches, and the warmth of African hospitality. From Morocco''s medinas to Cape Town''s mountains, Africa captivates every visitor.',
  'May to October (varies by region)',
  'Multiple currencies across countries',
  'Multiple languages',
  'Africa/Cairo',
  'Visa requirements vary by country',
  ARRAY['Pyramids of Giza', 'Table Mountain', 'Serengeti Safari', 'Victoria Falls', 'Marrakech Medina', 'Mount Kilimanjaro', 'Sahara Desert', 'Kruger National Park']
);

INSERT INTO landing_page_destinations (landing_page_id, name, image_url, description, display_order)
VALUES 
  ((SELECT id FROM landing_pages WHERE slug = 'africa'), 'Egypt', 'https://images.unsplash.com/photo-1539768942893-daf53e448371?w=400', 'Ancient civilization and Nile wonders', 1),
  ((SELECT id FROM landing_pages WHERE slug = 'africa'), 'Morocco', 'https://images.unsplash.com/photo-1489749798305-4fea3ae63d43?w=400', 'Exotic souks and desert landscapes', 2),
  ((SELECT id FROM landing_pages WHERE slug = 'africa'), 'South Africa', 'https://images.unsplash.com/photo-1484318571209-661cf29a69c3?w=400', 'Safari adventures and Cape Town beauty', 3),
  ((SELECT id FROM landing_pages WHERE slug = 'africa'), 'Kenya', 'https://images.unsplash.com/photo-1516426122078-c23e76319801?w=400', 'Wildlife safaris and Maasai culture', 4);

INSERT INTO landing_page_experiences (landing_page_id, icon, title, description, display_order)
VALUES 
  ((SELECT id FROM landing_pages WHERE slug = 'africa'), 'FaCamera', 'Safari Adventures', 'Big Five and wildlife encounters', 1),
  ((SELECT id FROM landing_pages WHERE slug = 'africa'), 'FaGlobe', 'Ancient History', 'Pyramids and archaeological sites', 2),
  ((SELECT id FROM landing_pages WHERE slug = 'africa'), 'FaMountain', 'Desert & Mountains', 'Sahara dunes and Mount Kilimanjaro', 3),
  ((SELECT id FROM landing_pages WHERE slug = 'africa'), 'FaUmbrellaBeach', 'Coastal Beauty', 'Indian Ocean and Atlantic shores', 4);

INSERT INTO landing_page_travel_tips (landing_page_id, icon, title, tip, display_order)
VALUES 
  ((SELECT id FROM landing_pages WHERE slug = 'africa'), 'FaClock', 'Best Time', 'Dry season (May-October) best for safaris', 1),
  ((SELECT id FROM landing_pages WHERE slug = 'africa'), 'FaPlane', 'Getting Around', 'Domestic flights recommended; organized tours for safaris', 2),
  ((SELECT id FROM landing_pages WHERE slug = 'africa'), 'FaMoneyBillWave', 'Budget', 'Varies widely; $50-150 per day depending on country', 3),
  ((SELECT id FROM landing_pages WHERE slug = 'africa'), 'FaGlobe', 'Health', 'Check vaccination requirements; malaria prophylaxis for some areas', 4);
...
INSERT INTO landing_pages (
  ...
  'https://images.unsplash.com/photo-1502602898657-3e91760cbb34?w=1200',
  'Europe enchants with its rich history, diverse cultures, world-class art, stunning architecture, and culinary excellence. From Mediterranean beaches to Alpine peaks, from ancient ruins to modern capitals, Europe offers centuries of heritage and unforgettable experiences in every corner.',
  'April to October (Spring to Fall)',
  'Euro (EUR) in most countries, various others',
  'Multiple languages',
  'Europe/Paris',
  'Schengen visa allows travel to 27 countries',
  ARRAY['Eiffel Tower', 'Colosseum', 'Sagrada Familia', 'Big Ben', 'Neuschwanstein Castle', 'Acropolis', 'Swiss Alps', 'Northern Lights']
);

INSERT INTO landing_page_destinations (landing_page_id, name, image_url, description, display_order)
VALUES 
  ((SELECT id FROM landing_pages WHERE slug = 'europe'), 'France', 'https://images.unsplash.com/photo-1502602898657-3e91760cbb34?w=400', 'Romance, art, and world-class cuisine', 1),
  ((SELECT id FROM landing_pages WHERE slug = 'europe'), 'Italy', 'https://images.unsplash.com/photo-1523906834658-6e24ef2386f9?w=400', 'Timeless art, history, and culinary perfection', 2),
  ((SELECT id FROM landing_pages WHERE slug = 'europe'), 'Spain', 'https://images.unsplash.com/photo-1543783207-ec64e4d95325?w=400', 'Passionate culture and Mediterranean beauty', 3),
  ((SELECT id FROM landing_pages WHERE slug = 'europe'), 'Greece', 'https://images.unsplash.com/photo-1613395877344-13d4a8e0d49e?w=400', 'Ancient mythology and island paradise', 4);

INSERT INTO landing_page_experiences (landing_page_id, icon, title, description, display_order)
VALUES 
  ((SELECT id FROM landing_pages WHERE slug = 'europe'), 'FaCamera', 'Historic Sites', 'Castles, palaces, and ancient ruins', 1),
  ((SELECT id FROM landing_pages WHERE slug = 'europe'), 'FaUtensils', 'Culinary Excellence', 'Michelin stars and local specialties', 2),
  ((SELECT id FROM landing_pages WHERE slug = 'europe'), 'FaGlobe', 'Art & Culture', 'World-renowned museums and galleries', 3),
  ((SELECT id FROM landing_pages WHERE slug = 'europe'), 'FaMountain', 'Scenic Beauty', 'Alps, fjords, and coastal views', 4);

INSERT INTO landing_page_travel_tips (landing_page_id, icon, title, tip, display_order)
VALUES 
  ((SELECT id FROM landing_pages WHERE slug = 'europe'), 'FaClock', 'Best Time', 'April-October for most countries; avoid August crowds', 1),
  ((SELECT id FROM landing_pages WHERE slug = 'europe'), 'FaPlane', 'Getting Around', 'Excellent train network; budget airlines for longer distances', 2),
  ((SELECT id FROM landing_pages WHERE slug = 'europe'), 'FaMoneyBillWave', 'Budget', '€70-150 per day varies by country', 3),
  ((SELECT id FROM landing_pages WHERE slug = 'europe'), 'FaGlobe', 'Schengen Visa', 'One visa covers 27 countries; check requirements', 4);