...
const Itineraries = ({
  ...
  const handleSaveToDB = async () => {
    if (modifiedItems.size === 0 && newItems.size === 0 && itemsToDelete.size === 0) {
  ...
  const getTotalChanges = () => modifiedItems.size + newItems.size + itemsToDelete.size
            ...
            <ul>
              ...
              >
                {(value as any[]).map((item, i) => {
                  ...
                  const isMarkedForDeletion = item.id && itemsToDelete.has(item.id)
                        ...
                        <div className='w-full flex justify-between relative'>
                          {editIndex === i ? (
                            ...
                            <div className='flex items-center gap-2'>
                              <p className={isMarkedForDeletion ? 'line-through' : ''}>
                                {item.day_title}
                              </p>
                              {isNew && (
                      ...
                      <AccordionContent className='flex flex-col gap-4 text-balance'>
                        {editIndex === i ? (
                          ...
                          <div className='flex justify-end space-x-3 items-center'>
                            <label htmlFor={`delete-${i}`}>mark for delete</label>
                            <Checkbox
                              id={`delete-${i}`}
                        ...
                        {editIndex === i ? (
                          ...
                          <p className={isMarkedForDeletion ? 'line-through opacity-60' : ''}>
